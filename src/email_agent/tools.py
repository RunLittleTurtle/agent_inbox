...
# Gmail MCP Tools discovered via discovery script
# Updated with actual available tools from Pipedream MCP server
USEFUL_TOOL_NAMES = {
    # Core Email Operations
    'gmail-send-email',  # Send an email from your Google Workspace email account
    'gmail-find-email',  # Find an email using Google's Search Engine
    'gmail-create-draft',  # Create a draft from your Google Workspace email account

    # Email Management
    'gmail-archive-email',  # Archive an email message
    'gmail-delete-email',  # Moves the specified message to the trash

    # Label Management
    'gmail-list-labels',  # List all the existing labels in the connected account
    'gmail-create-label',  # Create a new label in the connected account
    'gmail-add-label-to-email',  # Add label(s) to an email message
    'gmail-remove-label-from-email',  # Remove label(s) from an email message

    # Attachments
    'gmail-download-attachment',  # Download an attachment by attachmentId to the /tmp directory

    # Signatures & Aliases
    'gmail-list-send-as-aliases',  # List all send as aliases for the authenticated user
    'gmail-get-send-as-alias',  # Get a send as alias for the authenticated user
    'gmail-update-primary-signature',  # Update the signature for the primary email address
    'gmail-update-org-signature',  # Update the signature for a specific email address in an organization

    # Workflow
    'gmail-approve-workflow',  # Suspend the workflow until approved by email
}
