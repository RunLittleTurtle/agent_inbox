...
# Google Drive MCP Tools from https://mcp.pipedream.com/app/google_drive
# All 30 available tools for comprehensive file management
USEFUL_TOOL_NAMES = {
    # File Operations - CORRECTED NAMES from MCP server
    ...
    'google_drive-copy-file',
    'google_drive-delete-file',
    'google_drive-find-file',
    'google_drive-get-file-by-id',

    # File Creation - CORRECTED NAMES
    'google_drive-create-file-from-text',
    'google_drive-create-file-from-template',

    # Folder Operations - CORRECTED NAMES
    'google_drive-create-folder',
    'google_drive-find-folder',
    'google_drive-get-folder-id-for-path',

    # File Listing and Search - CORRECTED NAMES
    'google_drive-list-files',
    'google_drive-search-shared-drives',
    'google_drive-find-spreadsheets',
    'google_drive-find-forms',

    # Sharing and Permissions - CORRECTED NAMES
    'google_drive-add-file-sharing-preference',
    'google_drive-resolve-access-proposal',
    'google_drive-list-access-proposals',

    # Shared Drive Management - CORRECTED NAMES
    'google_drive-create-shared-drive',
    'google_drive-update-shared-drive',
    'google_drive-get-shared-drive',
    'google_drive-delete-shared-drive',

    # Comments - CORRECTED NAMES
    'google_drive-add-comment',
    'google_drive-reply-to-comment',
    'google_drive-resolve-comment',
    'google_drive-list-comments',
